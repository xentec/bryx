...
\item Compiler: clang + libcxx \\
Bessere Fehlermeldungen im Vergleich zu GCC.
\item Betriebssystem: Arch Linux \\
Standardbetriebssystem des Teams.
\item Projektgenerator: CMake \\
Einfache und einheitliche Generierung der Projektdateien.
\item IDE: QtCreator \\
Eine gute OSS Alternative zu Visual Studio, die u.a. CMake versteht und dank Clang Static Analyzer semantische Fehler während des Schreibens anzeigt.
\item Dokumentationsgenerator: Doxygen \\
...
Typsichere Formatierung und Konsolenausgabe.
